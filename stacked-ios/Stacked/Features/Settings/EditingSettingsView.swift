...
/// Preferências de criação e detalhe da tarefa.
          ...
          VStack(spacing: 0) {
            HStack(spacing: 12) {
              settingsLabel(
                ...
                subtitle: "Campo de notas abaixo do título"
              )
              Spacer(minLength: 8)
            ...
            SettingsCardDivider(leadingPadding: 48)

            HStack(spacing: 12) {
              settingsLabel(
                icon: "note.text",
                title: "Notas no menu",
                subtitle: "No detalhe, editor pelo menu; desligado fica sob o título"
              )
              Spacer(minLength: 8)
              SettingsSwitchToggle(
                isOn: Binding(
