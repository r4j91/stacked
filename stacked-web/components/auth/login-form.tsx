        ...
        <form onSubmit={onSubmit} className="space-y-3">
          <div>
            ...
            <input
              ...
              className="w-full rounded-[var(--radius-md)] border border-[var(--color-border)] bg-[var(--color-surface)] px-3.5 py-2.5 text-sm outline-none focus:border-[var(--color-border-strong)]"
            />
          </div>
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-[var(--radius-md)] border border-[var(--color-border)] bg-[var(--color-surface)] px-3.5 py-2.5 pr-10 text-sm outline-none focus:border-[var(--color-border-strong)]"
              />
              <button
                type="button"
